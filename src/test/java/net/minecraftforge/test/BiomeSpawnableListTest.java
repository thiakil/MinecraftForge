...
{
    private static LaunchClassLoadedTestHelper testHelper;

    @SuppressWarnings("unchecked")
    @BeforeClass
    public static void setUp() throws Exception
    {
        testHelper = new LaunchClassLoadedTestHelper("net.minecraftforge.test.BiomeSpawnableListTest$LaunchclassLoaded", "net.minecraftforge.fml.common.asm.transformers.EnumConstructorTransformer");
    }

    @Test
    public void testAddAndRemoveSpawn() throws Exception
    {
        testHelper.runTestMethod("testAddAndRemoveSpawn");
    }
